...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(5, 25, 166, 186))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "追踪关系填写"))
        self.label_2.setText(_translate("MainWindow", "被测软件名："))
        self.label_3.setText(_translate("MainWindow", "被测软件标识："))
        self.label_4.setText(_translate("MainWindow", "测试.C文件（待优化）："))
